"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[4263],{
...
const putUser = async (id, body) => {
  const { put } = (0,dist.getFetchClient)();
...
const EditPage = ({ canUpdate }) => {
  ...
  const { setUserDisplayName } = (0,dist.useAppInfo)();
  ...
  const handleSubmit = async (body, actions) => {
    ...
    try {
      ...
      const userInfos = dist.auth.getUserInfo();
      if (id.toString() === userInfos.id.toString()) {
        dist.auth.setUserInfo(data);
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Users" }), /* @__PURE__ */ react.createElement(
      HeaderLayout/* HeaderLayout */.T,
      {
        ...
        title,
        navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/settings/users?pageSize=10&page=1&sort=firstname" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Users" }), /* @__PURE__ */ react.createElement(
    ...
    ({ errors, values, handleChange, isSubmitting, dirty }) => {
      return /* @__PURE__ */ react.createElement(dist.Form, null, /* @__PURE__ */ react.createElement(
        HeaderLayout/* HeaderLayout */.T,
        {
...
const ProtectedEditPage = () => {
  ...
  } = (0,dist.useRBAC)(memoizedPermissions);
...
const commonUserSchema = {
  firstname: es/* string */.Z_().trim().required(dist.translatedErrors.required),
  lastname: es/* string */.Z_(),
  email: es/* string */.Z_().email(dist.translatedErrors.email).lowercase().required(dist.translatedErrors.required),
  username: es/* string */.Z_().nullable(),
  password: es/* string */.Z_().min(8, dist.translatedErrors.minLength).matches(/[a-z]/, "components.Input.error.contain.lowercase").matches(/[A-Z]/, "components.Input.error.contain.uppercase").matches(/\d/, "components.Input.error.contain.number"),
  confirmPassword: es/* string */.Z_().min(8, dist.translatedErrors.minLength).oneOf([es/* ref */.iH("password"), null], "components.Input.error.password.noMatch").when("password", (password, passSchema) => {
    return password ? passSchema.required(dist.translatedErrors.required) : passSchema;
  })
};
const schema = {
  ...commonUserSchema,
  currentPassword: es/* string */.Z_().when(["password", "confirmPassword"], (password, confirmPassword, passSchema) => {
    return password || confirmPassword ? passSchema.required(dist.translatedErrors.required) : passSchema;
  }),
...
const roles_schema = {
  roles: es/* array */.IX().min(1, dist.translatedErrors.required).required(dist.translatedErrors.required)
};
