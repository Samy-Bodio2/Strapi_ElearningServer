"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[9460],{
...
const schema = yup_es/* object */.Ry().shape({
  ...
  email_reset_password: yup_es/* string */.Z_(dist.translatedErrors.string).matches(URL_REGEX, dist.translatedErrors.regex).nullable()
});
...
const ProtectedAdvancedSettingsPage = () => /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: constants/* PERMISSIONS */._.readAdvancedSettings }, /* @__PURE__ */ react.createElement(AdvancedSettingsPage, null));
const AdvancedSettingsPage = () => {
  ...
  } = (0,dist.useRBAC)({ update: constants/* PERMISSIONS */._.updateAdvancedSettings });
