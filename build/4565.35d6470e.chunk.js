"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[4565],{
...
function ReviewWorkflowsStageEE({ color, name }) {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", gap: 2, maxWidth: (0,dist.pxToRem)(300) }, /* @__PURE__ */ react.createElement(
    Box/* Box */.x,
    {
      height: 2,
      background: color,
