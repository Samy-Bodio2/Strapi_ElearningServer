"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[8056],{
...
const LinkStyled = (0,styled_components_browser_esm["default"])((0,dist.Link))`
  svg {
    path {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedTokens.map((token) => {
      return /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,dist.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", fontWeight: "bold", ellipsis: true }, token.name)),
        /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,dist.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", ellipsis: true }, token.description)),
        /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, /* @__PURE__ */ react.createElement(dist.RelativeTime, { timestamp: new Date(token.createdAt) }))),
...
const ApiTokenListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, !canRead && /* @__PURE__ */ react.createElement(dist.NoPermissions, null), shouldDisplayDynamicTable && /* @__PURE__ */ react.createElement(
    Table/* default */.Z,
    {
    ...
    dist.NoContent,
    {
      ...
      action: /* @__PURE__ */ react.createElement(dist.LinkButton, { variant: "secondary", startIcon: /* @__PURE__ */ react.createElement(Plus/* default */.Z, null), to: "/settings/api-tokens/create" }, formatMessage({
...
const ProtectedApiTokenListView = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.settings["api-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
};
