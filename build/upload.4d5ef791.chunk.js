"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[3650],{
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(dist.PaginationURLQuery, { pagination })));
};
...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  const handleSubmit = async (values, { setErrors }) => {
    try {
      ...
      const normalizedError = (0,dist.normalizeAPIError)(error);
...
const Filters = () => {
  ...
  const [{ query }, setQuery] = (0,dist.useQueryParams)();
...
const MediaLibrary = () => {
  ...
  const [view, setView] = (0,dist.usePersistentState)(constants/* localStorageKeys */.uf.view, constants/* viewOptions */.Uk.GRID);
  ...
  const [selected, { selectOne, selectAll }] = (0,dist.useSelectionState)(["type", "id"], []);
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    ...
    ActionLayout/* ActionLayout */.Z,
    {
      ...
      endActions: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(dist.CheckPermissions, { permissions: constants/* PERMISSIONS */._I.configureView }, /* @__PURE__ */ react.createElement(ActionContainer, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
  ...
  ), isLoading && /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null), (assetsError || foldersError) && /* @__PURE__ */ react.createElement(dist.AnErrorOccurred, null), folderCount === 0 && assetCount === 0 && /* @__PURE__ */ react.createElement(
...
const Upload = () => {
  ...
  const [{ rawQuery }, setQuery] = (0,dist.useQueryParams)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  ...
  (0,dist.useFocusWhenNavigate)();
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(Helmet/* Helmet */.q, { title }), isLoading && /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null), rawQuery ? /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { exact: true, path: `/plugins/${pluginId/* default */.Z}`, component: MediaLibrary }), /* @__PURE__ */ react.createElement(
