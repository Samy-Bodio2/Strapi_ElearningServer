"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[801],{
...
const FieldWrapper = (0,styled_components_browser_esm["default"])((0,Field/* Field */.g))`
  height: ${32 / 16}rem;
  width: ${32 / 16}rem;
...
const NpsSurvey = () => {
  ...
  const { currentEnvironment, strapiVersion } = (0,dist.useAppInfo)();
  ...
  const handleSubmitResponse = ({ npsSurveyRating: rating, npsSurveyFeedback: comment }) => {
    const { email } = dist.auth.getUserInfo();
    mutate({
      email,
      rating,
      comment,
...
const StepperModal = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, justifyContent: "center", minWidth: (0,dist.pxToRem)(30) }, hasSectionBefore && /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,dist.pxToRem)(24) })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "primary600" }, formatMessage({
    id: "app.components.GuidedTour.title",
    defaultMessage: "3 steps to get started"
  }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, minWidth: (0,dist.pxToRem)(30) }, /* @__PURE__ */ react.createElement(
    components_StepNumberWithPadding,
    {
      number: sectionIndex + 1,
      type: hasStepsBefore ? constants/* IS_DONE */.hx : constants/* IS_ACTIVE */.lW
    }
  )), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, direction: "column", justifyContent: "center", minWidth: (0,dist.pxToRem)(30) }, hasSectionAfter && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx }), hasStepsBefore && /* @__PURE__ */ react.createElement(components_StepNumberWithPadding, { number: nextSectionIndex + 1, type: constants/* IS_ACTIVE */.lW, last: true }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(components_Content, { ...content }), cta && (cta.target ? /* @__PURE__ */ react.createElement(dist.LinkButton, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null), onClick: onCtaClick, to: cta.target }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(Button/* Button */.z, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null), onClick: onCtaClick }, formatMessage(cta.title))))), hasStepsBefore && hasSectionAfter && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, justifyContent: "center", width: (0,dist.pxToRem)(30) }, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,dist.pxToRem)(24) }))));
};
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const [condensed, setCondensed] = (0,dist.usePersistentState)("navbar-condensed", false);
  const { userDisplayName } = (0,dist.useAppInfo)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,dist.useTracking)();
  const { pathname } = (0,react_router/* useLocation */.TH)();
  const history = (0,react_router/* useHistory */.k6)();
  const { post } = (0,dist.getFetchClient)();
...
const Onboarding = () => {
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { communityEdition } = (0,dist.useAppInfo)();
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(7874), __webpack_require__.e(2217), __webpack_require__.e(7649), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 85602))
);
...
const MarketplacePage = (0,react.lazy)(
  () => Promise.all(/* import() | Admin_marketplace */[__webpack_require__.e(7492), __webpack_require__.e(5516)]).then(__webpack_require__.bind(__webpack_require__, 9117))
);
...
const PluginsInitializer = () => {
  const { plugins: appPlugins } = (0,dist.useStrapiApp)();
  ...
  if (hasApluginNotReady) {
    ...
    return /* @__PURE__ */ react.createElement(react.Fragment, null, initializers, /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null));
  }
...
const RBACProvider = ({ children, permissions, refetchPermissions }) => {
  ...
  return /* @__PURE__ */ react.createElement(dist.RBACProviderContext.Provider, { value: { allPermissions, refetchPermissions } }, children);
};
...
const { get: api_get } = (0,dist.getFetchClient)();
...
const AuthenticatedApp = () => {
  const { setGuidedTourVisibility } = (0,dist.useGuidedTour)();
  const toggleNotification = (0,dist.useNotification)();
  const userInfo = dist.auth.getUserInfo();
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(71068);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79263);
