"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[302],{
...
const schema = yup_es/* object */.Ry().shape({
  autoRegister: yup_es/* bool */.Xg().required(dist.translatedErrors.required),
  defaultRole: yup_es/* mixed */.nK().when("autoRegister", (value, initSchema) => {
    return value ? initSchema.required(dist.translatedErrors.required) : initSchema.nullable();
  }),
...
const SingleSignOn = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "SSO" }), /* @__PURE__ */ react.createElement(Main/* Main */.o, { tabIndex: -1 }, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, isLoading ? /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      direction: "column",
      alignItems: "stretch",
...
const ProtectedSSO = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.settings.sso.main }, /* @__PURE__ */ react.createElement(SingleSignOn, null));
};
