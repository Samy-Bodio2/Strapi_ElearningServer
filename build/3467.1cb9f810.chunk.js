"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[3467],{
...
const FormHead = ({
  ...
  return /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: backUrl }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      })),
      ellipsis: true
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(71068);
...
var format = __webpack_require__(5728);
...
const schema = es/* object */.Ry().shape({
  name: es/* string */.Z_(dist.translatedErrors.string).max(100).required(dist.translatedErrors.required),
  type: es/* string */.Z_(dist.translatedErrors.string).oneOf(["read-only", "full-access", "custom"]).required(dist.translatedErrors.required),
  description: es/* string */.Z_().nullable(),
  lifespan: es/* number */.Rx().integer().min(0).nullable().defined(dist.translatedErrors.required)
});
...
const LoadingView = ({ transferTokenName }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
...
const schema = yup_es/* object */.Ry().shape({
  name: yup_es/* string */.Z_(dist.translatedErrors.string).max(100).required(dist.translatedErrors.required),
  description: yup_es/* string */.Z_().nullable(),
  lifespan: yup_es/* number */.Rx().integer().min(0).nullable().defined(dist.translatedErrors.required),
  permissions: yup_es/* string */.Z_(dist.translatedErrors.string).required(dist.translatedErrors.required)
});
/* harmony default export */ const utils_schema = (schema);
...
const TransferTokenCreateView = () => {
  ...
  } = (0,dist.useRBAC)(permissions.settings["transfer-tokens"]);
  const {
    params: { id }
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
