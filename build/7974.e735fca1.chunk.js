"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[7974],{
...
function StageSelect() {
  const { initialData, layout: contentType, isSingleType, onChange } = (0,dist.useCMEditViewDataManager)();
  const { put } = (0,dist.useFetchClient)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { formatAPIError } = (0,dist.useAPIErrorHandler)();
  const toggleNotification = (0,dist.useNotification)();
