"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[5516],{
...
const InstallPluginButton = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,dist.useTracking)();
  const { copy } = (0,dist.useClipboard)();
...
const PackageStats = ({ githubStars, npmDownloads, npmPackageType }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, !!githubStars && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Github/* default */.Z, height: (0,dist.pxToRem)(12), width: (0,dist.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Star/* default */.Z, height: (0,dist.pxToRem)(12), width: (0,dist.pxToRem)(12), color: "warning500", "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
  ...
  ), /* @__PURE__ */ react.createElement(VerticalDivider, { unsetMargin: false, background: "neutral200" })), /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Download/* default */.Z, height: (0,dist.pxToRem)(12), width: (0,dist.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
      "aria-label": formatMessage(
        {
...
const NpmPackagesGrid = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  if (status === "error") {
    return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { paddingTop: 8 }, /* @__PURE__ */ react.createElement(dist.AnErrorOccurred, null));
  }
  if (status === "loading") {
...
const NpmPackagesPagination = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.PageSizeURLQuery, { options: ["12", "24", "50", "100"], defaultValue: "24" }), /* @__PURE__ */ react.createElement(dist.PaginationURLQuery, { pagination })));
};
...
const MarketPlacePage = () => {
  ...
  const { autoReload: isInDevelopmentMode, dependencies, useYarn, strapiVersion } = (0,dist.useAppInfo)();
...
const ProtectedMarketPlace = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.marketplace.main }, /* @__PURE__ */ react.createElement(MarketPlacePage, null));
};
