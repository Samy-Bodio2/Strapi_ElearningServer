"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[3455],{
...
const RoleRow = ({ id, name, description, usersCount, icons, rowIndex, canUpdate }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    Tr.Tr,
    {
      ...
      key: id,
      ...canUpdate ? (0,dist.onRowClick)({
        fn: editObject.onClick
      }) : {}
    },
    /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,dist.pxToRem)(130) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { ellipsis: true, textColor: "neutral800" }, name)),
    /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,dist.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { ellipsis: true, textColor: "neutral800" }, description)),
    ...
    /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "flex-end", ...dist.stopPropagation }, icons.map(
...
const RoleListPage = () => {
  ...
  } = (0,dist.useRBAC)(permissions.settings.roles);
  const {
    roles,
    isLoading,
  ...
  if (isLoadingForPermissions) {
    return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null));
  }
...
const ProtectedListPage = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.settings.roles.main }, /* @__PURE__ */ react.createElement(ListPage, null));
};
