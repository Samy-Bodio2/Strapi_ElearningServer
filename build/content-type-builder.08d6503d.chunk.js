(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[8880],{
...
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_94__ = __webpack_require__(47929);
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(SubNavSections/* SubNavSections */.Z, null, menu.map((section) => /* @__PURE__ */ react.createElement(react.Fragment, { key: section.name }, /* @__PURE__ */ react.createElement(
      ...
      TextButton/* TextButton */.A,
      {
        ...
        startIcon: /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Plus/* default */.Z, width: (0,dist.pxToRem)(8), height: (0,dist.pxToRem)(8) }),
        marginTop: 2
      },
      formatMessage({
...
const CustomFieldsList = () => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const customFields = (0,dist.useCustomFields)();
...
const createCategorySchema = (usedCategoryNames) => {
  const shape = {
    name: yup_es/* string */.Z_().matches(regex, dist.translatedErrors.regex).test({
      name: "nameNotAllowed",
      message: dist.translatedErrors.unique,
      test(value) {
        if (!value) {
          return false;
        }
...
const createComponentSchema = (usedComponentNames, reservedNames, category) => {
  const shape = {
    ...
    category: yup_es/* string */.Z_().matches(regex, dist.translatedErrors.regex).required(dist.translatedErrors.required),
...
const validators = {
  ...
  name(usedNames, reservedNames) {
    return yup_es/* string */.Z_().test(alreadyUsedAttributeNames(usedNames)).test(isNameAllowed(reservedNames)).matches(NAME_REGEX, dist.translatedErrors.regex).required(dist.translatedErrors.required);
  },
  required: () => yup_es/* boolean */.O7(),
  type: () => yup_es/* string */.Z_().required(dist.translatedErrors.required),
...
const types = {
  ...
  biginteger(usedAttributeNames, reservedNames) {
    const shape = {
      ...
      unique: validators.unique(),
      required: validators.required(),
      max: yup_es/* string */.Z_().nullable().matches(/^-?\d*$/, dist.translatedErrors.regex),
      min: yup_es/* string */.Z_().nullable().test(isMinSuperiorThanMax).matches(/^-?\d*$/, dist.translatedErrors.regex)
    };
    return yup_es/* object */.Ry(shape);
  },
  ...
  component(usedAttributeNames, reservedNames) {
    const shape = {
      ...
      max: validators.max(),
      min: validators.min(),
      component: yup_es/* string */.Z_().required(dist.translatedErrors.required)
    };
    return yup_es/* object */.Ry(shape);
  },
  ...
  enumeration(usedAttributeNames, reservedNames) {
    ...
    const shape = {
      name: yup_es/* string */.Z_().test(alreadyUsedAttributeNames(usedAttributeNames)).test(isNameAllowed(reservedNames)).matches(GRAPHQL_ENUM_REGEX, dist.translatedErrors.regex).required(dist.translatedErrors.required),
      type: validators.type(),
      default: validators.default(),
      unique: validators.unique(),
      required: validators.required(),
      enum: yup_es/* array */.IX().of(yup_es/* string */.Z_()).min(1, dist.translatedErrors.min).test({
  ...
  relation(usedAttributeNames, reservedNames, alreadyTakenTargetAttributes, { initialData, modifiedData }) {
    const shape = {
      name: validators.name(usedAttributeNames, reservedNames),
      target: yup_es/* string */.Z_().required(dist.translatedErrors.required),
      ...
      targetAttribute: yup_es/* lazy */.Vo(() => {
        ...
        return schema.matches(NAME_REGEX, dist.translatedErrors.regex).test({
...
const FormModal = () => {
  ...
  const customField = (0,dist.useCustomFields)().get(customFieldUid);
  ...
  const { trackUsage } = (0,dist.useTracking)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { getPlugin } = (0,dist.useStrapiApp)();
...
const DataManagerProvider = ({
  ...
  const dispatch = (0,es/* useDispatch */.I0)();
  const toggleNotification = (0,dist.useNotification)();
  const { lockAppWithAutoreload, unlockAppWithAutoreload } = (0,dist.useAutoReloadOverlayBlocker)();
  const { setCurrentStep } = (0,dist.useGuidedTour)();
  const { getPlugin } = (0,dist.useStrapiApp)();
  const { apis } = getPlugin(pluginId/* default */.Z);
  const { autoReload } = (0,dist.useAppInfo)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,dist.useTracking)();
  const { refetchPermissions } = (0,dist.useRBACProvider)();
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    isLoadingForDataToBeSet ? /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(react.Fragment, null, children, isInDevelopmentMode && /* @__PURE__ */ react.createElement(components_FormModal, null))
  );
};
...
const RecursivePath = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `${url}/:componentUid` }, /* @__PURE__ */ react.createElement(ListView, { categoryId: categoryUid }))));
};
...
const App = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: src_constants/* PERMISSIONS */._.main }, /* @__PURE__ */ react.createElement(Helmet/* Helmet */.q, { title }), /* @__PURE__ */ react.createElement(components_FormModalNavigationProvider, null, /* @__PURE__ */ react.createElement(components_DataManagerProvider, null, /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(components_ContentTypeBuilderNav, null) }, /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(
