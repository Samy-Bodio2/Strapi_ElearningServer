"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[9497],{
...
const FieldActionWrapper = (0,styled_components_browser_esm["default"])((0,FieldAction/* FieldAction */.E))`
  svg {
    height: ${(0,dist.pxToRem)(16)};
    width: ${(0,dist.pxToRem)(16)};
    path {
  ...
  const submitMutation = (0,es.useMutation)(
    ...
    },
    {
      async onSuccess(data2) {
        ...
        dist.auth.setUserInfo({ email: email2, firstname: firstname2, lastname: lastname2, username: username2, preferedLanguage: preferedLanguage2 });
