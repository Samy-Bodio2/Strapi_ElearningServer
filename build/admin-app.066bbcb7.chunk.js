(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[5538],{
...
var darkTheme = __webpack_require__(88848);
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/DesignSystemProvider.mjs
var DesignSystemProvider = __webpack_require__(24460);
...
const Providers = ({
  ...
  return /* @__PURE__ */ react.createElement(components_LanguageProvider, { messages, localeNames }, /* @__PURE__ */ react.createElement(ThemeToggleProvider, { themes }, /* @__PURE__ */ react.createElement(Theme, null, /* @__PURE__ */ react.createElement(es.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ react.createElement(react_redux_es/* Provider */.zt, { store }, /* @__PURE__ */ react.createElement(contexts/* AdminContext */.ux.Provider, { value: { getAdminInjectedComponents } }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(dist.LibraryProvider, { components, fields }, /* @__PURE__ */ react.createElement(dist.CustomFieldsProvider, { customFields }, /* @__PURE__ */ react.createElement(dist.AutoReloadOverlayBlockerProvider, null, /* @__PURE__ */ react.createElement(dist.OverlayBlockerProvider, null, /* @__PURE__ */ react.createElement(components_GuidedTour, null, /* @__PURE__ */ react.createElement(dist.NotificationsProvider, null, children))))))
    )
  )))))));
};
Providers.propTypes = {
...
const PrivateRoute = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    ...
    {
      path,
      render: (props) => dist.auth.getToken() !== null ? /* @__PURE__ */ (0,jsx_runtime.jsx)(Component, { ...rest, ...props }) : /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
const ForgotPassword = ({ onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    ...
    ({ values, errors, handleChange }) => /* @__PURE__ */ react.createElement(dist.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* Logo */.T, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha" }, formatMessage({
  ...
  )), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }))))));
};
...
const ForgotPasswordSuccess = () => {
  ...
  }))))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(dist.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }))))));
};
...
const Register = ({ authType, fieldsToDisable, noSignin, onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    formik_esm/* Formik */.J9,
    {
      ...
      onSubmit: async (data, formik) => {
        ...
        try {
          ...
          const errors = (0,dist.getYupInnerErrors)(err);
    ...
    ({ values, errors, handleChange }) => {
      return /* @__PURE__ */ react.createElement(dist.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "center", gap: 3 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* Logo */.T, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha", textAlign: "center" }, formatMessage({
  ...
  ), !noSignin && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(dist.Link, { label: "Auth.link.signin", to: "/auth/login" }, formatMessage({
...
const FORMS = {
  ...
  login: {
    ...
    schema: yup_es/* object */.Ry().shape({
      email: yup_es/* string */.Z_().email(dist.translatedErrors.email).required(dist.translatedErrors.required),
      password: yup_es/* string */.Z_().required(dist.translatedErrors.required),
  ...
  register: {
    ...
    schema: yup_es/* object */.Ry().shape({
      firstname: yup_es/* string */.Z_().trim().required(dist.translatedErrors.required),
      lastname: yup_es/* string */.Z_().nullable(),
      password: yup_es/* string */.Z_().min(8, dist.translatedErrors.minLength).matches(/[a-z]/, "components.Input.error.contain.lowercase").matches(/[A-Z]/, "components.Input.error.contain.uppercase").matches(/\d/, "components.Input.error.contain.number").required(dist.translatedErrors.required),
      confirmPassword: yup_es/* string */.Z_().oneOf([yup_es/* ref */.iH("password"), null], "components.Input.error.password.noMatch").required(dist.translatedErrors.required),
      registrationToken: yup_es/* string */.Z_().required(dist.translatedErrors.required)
    }),
  ...
  "register-admin": {
    ...
    schema: yup_es/* object */.Ry().shape({
      ...
      lastname: yup_es/* string */.Z_().nullable(),
      password: yup_es/* string */.Z_().min(8, dist.translatedErrors.minLength).matches(/[a-z]/, "components.Input.error.contain.lowercase").matches(/[A-Z]/, "components.Input.error.contain.uppercase").matches(/\d/, "components.Input.error.contain.number").required(dist.translatedErrors.required),
      email: yup_es/* string */.Z_().email(dist.translatedErrors.email).strict().lowercase(dist.translatedErrors.lowercase).required(dist.translatedErrors.required),
      confirmPassword: yup_es/* string */.Z_().oneOf([yup_es/* ref */.iH("password"), null], "components.Input.error.password.noMatch").required(dist.translatedErrors.required)
    }),
    inputsPrefix: ""
  },
...
const AuthPage = ({ hasAdmin, setHasAdmin }) => {
  ...
  const { setSkipped } = (0,dist.useGuidedTour)();
  const { trackUsage } = (0,dist.useTracking)();
  const {
    params: { authType }
  ...
  const loginRequest = async (body, requestURL, { setSubmitting, setErrors }) => {
    try {
      ...
      dist.auth.setToken(token, body.rememberMe);
      dist.auth.setUserInfo(user, body.rememberMe);
  ...
  const registerRequest = async (body, requestURL, { setSubmitting, setErrors }) => {
    try {
      ...
      dist.auth.setToken(token, false);
      dist.auth.setUserInfo(user, false);
      setSubmitting(false);
      setHasAdmin(true);
      const { roles } = user;
      if (roles) {
  ...
  if (!forms[authType] || hasAdmin && authType === "register-admin" || dist.auth.getToken()) {
...
const UseCasePage = () => {
  ...
  const { post } = (0,dist.useFetchClient)();
  const { firstname, email } = dist.auth.getUserInfo();
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { labelledBy: "usecase-title" }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement("form", { onSubmit: (e) => handleSubmit(e, false) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", paddingBottom: 7 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* Logo */.T, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6, paddingBottom: 1, width: (0,dist.pxToRem)(250) }, /* @__PURE__ */ react.createElement(TypographyCenter, { variant: "alpha", as: "h1", id: "usecase-title" }, formatMessage({
    id: "Usecase.title",
...
const AuthenticatedApp = (0,react.lazy)(
  () => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(3888), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 84044))
);
function App() {
  ...
  const appInfo = (0,dist.useAppInfo)();
  ...
  (0,react.useEffect)(() => {
    const currentToken = dist.auth.getToken();
    const renewToken = async () => {
      try {
        ...
        dist.auth.updateToken(token);
      } catch (err) {
        dist.auth.clearAppStorage();
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      try {
        ...
        updateProjectSettings({
          menuLogo: (0,dist.prefixFileUrlWithBackendUrl)(menuLogo),
          authLogo: (0,dist.prefixFileUrlWithBackendUrl)(authLogo)
        });
        if (uuid2) {
          const {
  ...
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(SkipToContent/* SkipToContent */.z, null, formatMessage({ id: "skipToContent" })), /* @__PURE__ */ react.createElement(dist.TrackingProvider, { value: trackingInfo }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, authRoutes, /* @__PURE__ */ react.createElement(
    react_router/* Route */.AW,
    {
      path: "/auth/:authType",
...
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79263);

function useNpsSurveySettings() {
  const [npsSurveySettings, setNpsSurveySettings] = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__.usePersistentState)(
...
const useMenu = () => {
  const { allPermissions: userPermissions } = (0,dist.useRBACProvider)();
  const { shouldUpdateStrapi } = (0,dist.useAppInfo)();
  const { menu } = (0,dist.useStrapiApp)();
...
const useSettingsMenu = () => {
  ...
  const { allPermissions: userPermissions } = (0,dist.useRBACProvider)();
  const { shouldUpdateStrapi } = (0,dist.useAppInfo)();
  const { settings } = (0,dist.useStrapiApp)();
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
      ...
      const buildMenuPermissions = (sections2) => Promise.all(
        sections2.reduce((acc, section, sectionIndex) => {
          const buildMenuPermissions2 = (links) => links.map(async (link, linkIndex) => ({
            hasPermission: await (0,dist.hasPermissions)(userPermissions, link.permissions),
            sectionIndex,
            linkIndex
          }));
...
function useEnterprise(ceData, eeCallback, { defaultValue = null, combine = (ceData2, eeData) => eeData, enabled = true } = {}) {
  const eeCallbackRef = (0,dist.useCallbackRef)(eeCallback);
  const combineCallbackRef = (0,dist.useCallbackRef)(combine);
...
/* harmony import */ var _strapi_design_system__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(71068);
...
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79263);
...
const Login = ({ onSubmit, schema, children }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_9__/* .Main */ .o, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_4__/* .LayoutContent */ .bU, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    ({ values, errors, handleChange }) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.Form, { noValidate: true }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_4__/* .Column */ .sg, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_3__/* .Logo */ .T, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_10__/* .Box */ .x, { paddingTop: 6, paddingBottom: 1 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_11__/* .Typography */ .Z, { variant: "alpha", as: "h1" }, formatMessage({
      id: "Auth.form.welcome.title",
...
const LazyCompo = ({ loadComponent }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.LoadingIndicatorPage, null);
};
