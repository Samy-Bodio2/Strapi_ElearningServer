"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[3677],{
...
const Plugins = () => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": true }, /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null)));
  }
...
const InstalledPluginsPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.marketplace.main }, /* @__PURE__ */ react.createElement(
    Helmet/* Helmet */.q,
    {
      title: formatMessage({
        id: "global.plugins",
