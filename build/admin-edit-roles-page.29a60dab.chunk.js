(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[2544],{
...
const CreatePage = () => {
  ...
  const { post, put } = (0,dist.useFetchClient)();
  const { params } = route ?? {};
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, errors, handleReset, handleChange }) => /* @__PURE__ */ react.createElement(dist.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
      HeaderLayout/* HeaderLayout */.T,
      {
        ...
        navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/settings/roles" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
    ...
    )) : /* @__PURE__ */ react.createElement(Box/* Box */.x, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null))))))
  ));
};
/* harmony default export */ function Roles_CreatePage() {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.settings.roles.create }, /* @__PURE__ */ react.createElement(CreatePage, null));
}
...
const Permissions = (0,react.forwardRef)(({ layout, isFormDisabled, permissions }, ref) => {
  ...
  (0,react.useImperativeHandle)(ref, () => {
    return {
      getPermissions() {
        const collectionTypesDiff = (0,dist.difference)(
          initialData.collectionTypes,
          modifiedData.collectionTypes
        );
        const singleTypesDiff = (0,dist.difference)(initialData.singleTypes, modifiedData.singleTypes);
