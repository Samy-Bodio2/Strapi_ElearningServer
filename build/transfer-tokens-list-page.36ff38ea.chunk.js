"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[9600],{
...
const TransferTokenListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
...
const ProtectedTransferTokenListView = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.settings["transfer-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
};
