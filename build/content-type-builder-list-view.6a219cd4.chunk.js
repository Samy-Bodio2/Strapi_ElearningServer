"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[5905],{
...
const Tr_Tr = styled_components_browser_esm["default"].tr`
  ...
  &.dynamiczone-row {
    ...
    > td:first-of-type {
      padding: 0 0 0 ${(0,dist.pxToRem)(20)};
      position: relative;

      &::before {
        content: '';
        width: ${(0,dist.pxToRem)(4)};
...
const CloseButton = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  ...
  display: none;
  top: 5px;
  right: ${(0,dist.pxToRem)(8)};

  svg {
    width: ${(0,dist.pxToRem)(10)};
    height: ${(0,dist.pxToRem)(10)};
...
const ComponentBox = (0,styled_components_browser_esm["default"])((0,Flex/* Flex */.k))`
  width: ${(0,dist.pxToRem)(140)};
  height: ${(0,dist.pxToRem)(80)};
  position: relative;
...
const StyledAddIcon = (0,styled_components_browser_esm["default"])((0,Plus/* default */.Z))`
  ...
  padding: ${(0,dist.pxToRem)(9)};
  border-radius: ${(0,dist.pxToRem)(64)};
  background: ${({ theme }) => theme.colors.primary100};
  path {
    fill: ${({ theme }) => theme.colors.primary600};
  }
...
function ListRow({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("td", null, isInDevelopmentMode ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "flex-end", ...dist.stopPropagation }, configurable ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, !isMorph && /* @__PURE__ */ react.createElement(
      ...
      */
      /* @__PURE__ */ react.createElement(Box/* Box */.x, { height: (0,dist.pxToRem)(32) })
    ))
  );
}
...
const LinkToCMSettingsView = ({
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPermissions, { permissions: permissionsToApply }, /* @__PURE__ */ react.createElement(
    Button/* Button */.z,
    {
...
const ListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/plugins/content-type-builder/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
