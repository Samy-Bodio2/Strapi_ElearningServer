(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[994],{
...
var Menu = __webpack_require__(10360);
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPermissions, { permissions }, /* @__PURE__ */ react.createElement(
    dist.LinkButton,
    {
...
var Question = __webpack_require__(47929);
...
const FieldTypeIcon = ({ type, customFieldUid }) => {
  const customFieldsRegistry = (0,dist.useCustomFields)();
...
var constants = __webpack_require__(65484);
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const toggleNotification = (0,dist.useNotification)();
  const { setCurrentStep } = (0,dist.useGuidedTour)();
  const { trackUsage } = (0,dist.useTracking)();
  const { push, replace } = (0,react_router/* useHistory */.k6)();
  const [{ query, rawQuery }] = (0,dist.useQueryParams)();
  ...
  const fetchClient = (0,dist.useFetchClient)();
  ...
  const cleanReceivedData = (0,react.useCallback)((data2) => {
    ...
    return (0,dist.formatContentTypeData)(
      cleaned,
      allLayoutDataRef.current.contentType,
      allLayoutDataRef.current.components
    );
  ...
  (0,react.useEffect)(() => {
    const componentsDataStructure2 = Object.keys(allLayoutData.components).reduce((acc, current) => {
      ...
      acc[current] = (0,dist.formatContentTypeData)(
    ...
    const contentTypeDataStructureFormatted = (0,dist.formatContentTypeData)(
...
const IconWrapper = styled_components_browser_esm["default"].span`
  > svg {
    width: ${(0,dist.pxToRem)(24)};
    height: ${(0,dist.pxToRem)(24)};
    > circle {
...
const ImageDialog = ({ handleClose }) => {
  const editor = (0,slate_react_dist_index_es/* useSlate */.ui)();
  const { components } = (0,dist.useLibrary)();
  ...
  const handleSelectAssets = (images) => {
    const formattedImages = images.map((image) => {
      ...
      return {
        ...
        url: (0,dist.prefixFileUrlWithBackendUrl)(image.url)
      };
    });
...
`;
const BlocksEditor_Wrapper = (0,styled_components_browser_esm["default"])((0,Box/* Box */.x))`
  width: 100%;
  overflow: auto;
  padding: ${({ theme }) => `${theme.spaces[3]} ${theme.spaces[4]}`};
...
const InputUID = react.forwardRef(
  ({
    ...
    const { modifiedData, initialData } = (0,dist.useCMEditViewDataManager)();
    const toggleNotification = (0,dist.useNotification)();
...
function useSelect({
  ...
  const {
    ...
    slug,
    modifiedData
  } = (0,dist.useCMEditViewDataManager)();
...
const useRelation = (cacheKey, { relation, search }) => {
  ...
  const onLoadRelationsCallback = (0,dist.useCallbackRef)(onLoadRelations);
  (0,react.useEffect)(() => {
...
const StyledBullet = styled_components_browser_esm["default"].div`
  flex-shrink: 0;
  width: ${(0,dist.pxToRem)(6)};
  height: ${(0,dist.pxToRem)(6)};
...
const RelationInput = ({
  ...
  const fieldRef = (0,dist.useFocusInputField)(name);
...
const RelationInputDataManager = ({
  ...
  if (!isFieldAllowed && isCreatingEntry || !isCreatingEntry && !isFieldAllowed && !isFieldReadable) {
    return /* @__PURE__ */ react.createElement(dist.NotAllowedInput, { name, intlLabel, labelAction });
  }
...
const EditorLayout = ({ children, isExpandMode, error, previewContent, onCollapse }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  (0,dist.useLockScroll)(isExpandMode);
  if (isExpandMode) {
  ...
  ({ hint, disabled, error, intlLabel, labelAction, name, onChange, placeholder, value, required }, forwardedRef) => {
    ...
    const handleSelectAssets = (files) => {
      const formattedFiles = files.map((f) => ({
        ...
        url: (0,dist.prefixFileUrlWithBackendUrl)(f.url),
        mime: f.mime
      }));
...
function Inputs({
  ...
  const { fields } = (0,dist.useLibrary)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
...
const DraggedItem = ({
  ...
  const { modifiedData, removeRepeatableField, triggerFormValidation } = (0,dist.useCMEditViewDataManager)();
...
const RepeatableComponent = ({
  ...
  const { addRepeatableComponentToField, formErrors, moveComponentField } = (0,dist.useCMEditViewDataManager)();
  const toggleNotification = (0,dist.useNotification)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
...
const FieldComponent = ({
  ...
  if (!hasChildrenAllowedFields && isCreatingEntry) {
    return /* @__PURE__ */ react.createElement(dist.NotAllowedInput, { labelAction, intlLabel, name });
  }
...
const DynamicComponent = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { getComponentLayout } = (0,hooks/* useContentTypeLayout */.PL)();
  const { modifiedData } = (0,dist.useCMEditViewDataManager)();
...
const DynamicZoneLabel = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", justifyContent: "center" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { maxWidth: (0,dist.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold", ellipsis: true }, intlLabel, "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold" }, "(", numberOfComponents, ")"), required && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "danger600" }, "*"), labelAction && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1 }, labelAction)), intlDescription && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, maxWidth: (0,dist.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", ellipsis: true }, formatMessage(intlDescription))))
  ));
};
...
const EditViewDataManagerProvider = ({
  ...
  const checkFormErrors = (0,react.useCallback)(
    async (dataToSet = {}) => {
      ...
      try {
        ...
        errors = (0,dist.getYupInnerErrors)(err);
        if (modifiedDZName) {
  ...
  const handleSubmit = (0,react.useCallback)(
    async (e) => {
      ...
      try {
        ...
        errors = {
          ...errors,
          ...(0,dist.getAPIInnerErrors)(err, { getTrad: utils/* getTrad */.OB })
        };
      }
      dispatch({
        type: "SET_FORM_ERRORS",
  ...
  return /* @__PURE__ */ react.createElement(
    dist.ContentManagerEditViewDataManagerContext.Provider,
    {
      value: {
        addComponentToDynamicZone,
        addNonRepeatableComponentToField,
    ...
    isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null)) : /* @__PURE__ */ react.createElement(react.Fragment, null, !isSaving ? /* @__PURE__ */ react.createElement(
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  const cleanReceivedData = (0,react.useCallback)(
    (data2) => {
      ...
      return (0,dist.formatContentTypeData)(cleaned, allLayoutData.contentType, allLayoutData.components);
    },
    [allLayoutData]
  );
  (0,react.useEffect)(() => {
...
function DeleteLink_utils_select_useSelect() {
  const { hasDraftAndPublish, modifiedData } = (0,dist.useCMEditViewDataManager)();
  let trackerProperty = {};
  if (hasDraftAndPublish) {
...
function DraftAndPublishBadge_utils_select_useSelect() {
  const { initialData, hasDraftAndPublish } = (0,dist.useCMEditViewDataManager)();
...
const getFieldsActionMatchingPermissions = (userPermissions, slug) => {
  const getMatchingPermissions = (action) => {
    const matched = (0,dist.findMatchingPermissions)(userPermissions, [
      {
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  return /* @__PURE__ */ react.createElement(DataManagementWrapper, { allLayoutData: layout, slug, id, origin }, ({
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: "aside", "aria-labelledby": "links" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(components_InjectionZone, { area: "contentManager.editView.right-links", slug }), slug !== "strapi::administrator" && /* @__PURE__ */ react.createElement(dist.CheckPermissions, { permissions: CTB_PERMISSIONS }, /* @__PURE__ */ react.createElement(
        dist.LinkButton,
        {
          onClick: () => {
            trackUsage("willEditEditLayout");
      ...
      )), /* @__PURE__ */ react.createElement(dist.CheckPermissions, { permissions: configurationPermissions }, /* @__PURE__ */ react.createElement(
        dist.LinkButton,
        {
          size: "S",
...
const Permissions = (props) => {
  ...
  const { isLoading, allowedActions } = (0,dist.useRBAC)(viewPermissions, props.userPermissions);
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null);
  }
...
const EditViewLayoutManager = ({ layout, ...rest }) => {
  ...
  const { runHookWaterfall } = (0,dist.useStrapiApp)();
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: goBackUrl, id: "go-back" }, formatMessage({ id: "global.back", defaultMessage: "Back" })),
      primaryAction: /* @__PURE__ */ react.createElement(
        Button/* Button */.z,
        {
          size: "S",
...
const Filter_Filter = ({ displayedFilters }) => {
  ...
  ), /* @__PURE__ */ react.createElement(dist.FilterListURLQuery, { filtersSchema: displayedFilters }));
};
...
const useAllowedAttributes = (contentType, slug) => {
  const { allPermissions } = (0,dist.useRBACProvider)();
  const readPermissionsForSlug = (0,dist.findMatchingPermissions)(allPermissions, [
    {
      action: "plugin::content-manager.explorer.read",
      subject: slug
    }
  ]);
  const canReadAdminUsers = (0,dist.findMatchingPermissions)(allPermissions, [
    {
...
const CheckboxDataCell = ({ rowId, index }) => {
  const { selectedEntries, onSelectRow } = (0,dist.useTableContext)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
...
const EntityActionsDataCell = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,dist.useTracking)();
  const { setSelectedEntries } = (0,dist.useTableContext)();
  const pluginsQueryParams = (0,hooks/* usePluginsQueryParams */.fi)();
  const {
    location: { pathname }
...
const Root = ({ children, onConfirmDelete, isConfirmDeleteRowOpen, setIsConfirmDeleteRowOpen }) => {
  ...
  const { selectedEntries, setSelectedEntries } = (0,dist.useTableContext)();
  const handleConfirmDelete = async () => {
    try {
      setIsLoading(true);
  ...
  return /* @__PURE__ */ react.createElement(dist.Table.Body, null, children, /* @__PURE__ */ react.createElement(
    ConfirmDialogDelete,
    {
...
const ConfirmDialogPublishAll = ({ isOpen, onToggleDialog, isConfirmButtonLoading, onConfirm }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { get } = (0,dist.useFetchClient)();
  const { selectedEntries } = (0,dist.useTableContext)();
  const toggleNotification = (0,dist.useNotification)();
  const { formatAPIError } = (0,dist.useAPIErrorHandler)(utils/* getTrad */.OB);
  const {
...
const SelectedEntriesTableContent = ({
  ...
  return /* @__PURE__ */ react.createElement(dist.Table.Content, null, /* @__PURE__ */ react.createElement(dist.Table.Head, null, /* @__PURE__ */ react.createElement(dist.Table.HeaderCheckboxCell, null), /* @__PURE__ */ react.createElement(dist.Table.HeaderCell, { fieldSchemaType: "number", label: "id", name: "id" }), shouldDisplayMainField && /* @__PURE__ */ react.createElement(dist.Table.HeaderCell, { fieldSchemaType: "string", label: "name", name: "name" }), /* @__PURE__ */ react.createElement(dist.Table.HeaderCell, { fieldSchemaType: "string", label: "status", name: "status" })), /* @__PURE__ */ react.createElement(dist.Table.LoadingBody, null), /* @__PURE__ */ react.createElement(dist.Table.Body, null, rowsToDisplay.map((row, index) => /* @__PURE__ */ react.createElement(Tr.Tr, { key: row.id }, /* @__PURE__ */ react.createElement(Body.CheckboxDataCell, { rowId: row.id, index }), /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, row.id)), shouldDisplayMainField && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, row[mainField])), /* @__PURE__ */ react.createElement(Cell.Td, null, isPublishing && entriesToPublish.includes(row.id) ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 2 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, formatMessage({
...
const SelectedEntriesModalContent = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { selectedEntries, rows, onSelectRow, isLoading, isFetching } = (0,dist.useTableContext)();
      ...
      if (data2.results) {
        ...
        const rows = data2.results.map((entry) => {
          try {
            ...
            validationErrors[entry.id] = (0,dist.getYupInnerErrors)(e);
            return entry;
          }
        });
...
const Media_Media = ({ url, mime, alternativeText, name, ext, formats }) => {
  const fileURL = (0,dist.prefixFileUrlWithBackendUrl)(url);
  if (mime.includes("image")) {
    const thumbnail = formats?.thumbnail?.url || null;
    const mediaURL = (0,dist.prefixFileUrlWithBackendUrl)(thumbnail) || fileURL;
    return /* @__PURE__ */ react.createElement(Avatar/* Avatar */.q, { src: mediaURL, alt: alternativeText || name, preview: true });
  }
  const fileExtension = (0,dist.getFileExtension)(ext);
...
function ListView({
  ...
  const toggleNotification = (0,dist.useNotification)();
  const { trackUsage } = (0,dist.useTracking)();
  const { allPermissions, refetchPermissions } = (0,dist.useRBACProvider)();
  ...
  const { users, isLoading: isLoadingAdminUsers } = (0,useAdminUsers/* useAdminUsers */.R)(
    { filter: { id: { in: selectedUserIds } } },
    {
      ...
      enabled: selectedUserIds.length > 0 && (0,dist.findMatchingPermissions)(allPermissions, [
        {
          action: "admin::users.read",
          subject: null
        }
        ...
        return [
          ...
          ...eeFilters.filter((eeFilter) => {
            if (eeFilter.name === "strapi_assignee") {
              return (0,dist.findMatchingPermissions)(allPermissions, [
                {
                  action: "admin::users.read",
                  subject: null
                }
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(dist.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/content-manager/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, canRead ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 4, direction: "column", alignItems: "stretch" }, /* @__PURE__ */ react.createElement(dist.Table.Root, { rows: data, isLoading, colCount }, /* @__PURE__ */ react.createElement(dist.Table.ActionBar, null, /* @__PURE__ */ react.createElement(
  ...
  )), /* @__PURE__ */ react.createElement(dist.Table.Content, null, /* @__PURE__ */ react.createElement(dist.Table.Head, null, /* @__PURE__ */ react.createElement(dist.Table.HeaderCheckboxCell, null), tableHeaders.map(({ fieldSchema, key, name, metadatas: metadatas2 }) => /* @__PURE__ */ react.createElement(
    dist.Table.HeaderCell,
    {
      key,
      name,
  ...
  )), /* @__PURE__ */ react.createElement(dist.Table.HeaderHiddenActionsCell, null)), /* @__PURE__ */ react.createElement(dist.Table.LoadingBody, null), /* @__PURE__ */ react.createElement(
    dist.Table.EmptyBody,
    {
  ...
  ))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.PageSizeURLQuery, { trackedEvent: "willChangeNumberOfEntriesPerPage" }), /* @__PURE__ */ react.createElement(dist.PaginationURLQuery, { pagination: { pageCount: pagination?.pageCount || 1 } }))) : /* @__PURE__ */ react.createElement(dist.NoPermissions, null)));
}
ListView.propTypes = {
  canCreate: (prop_types_default()).bool.isRequired,
  canDelete: (prop_types_default()).bool.isRequired,
...
const Permissions_Permissions = (props) => {
  const viewPermissions = (0,react.useMemo)(() => (0,utils/* generatePermissionsObject */.TA)(props.slug), [props.slug]);
  const { isLoading, allowedActions } = (0,dist.useRBAC)(viewPermissions, props.permissions);
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null);
  }
...
/* harmony default export */ const ListViewLayoutManager_Permissions = ((0,react.memo)(Permissions_Permissions, (prev, next) => {
  const differenceBetweenRerenders = (0,dist.difference)(prev, next);
...
const ErrorFallback = () => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 8 }, /* @__PURE__ */ react.createElement(dist.AnErrorOccurred, null));
};
...
const ComponentSettingsView = () => {
  ...
  return /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.contentManager.componentsConfigurations }, /* @__PURE__ */ react.createElement(pages_EditSettingsView, { components: layout.components, mainLayout: layout.component, slug: uid }));
};
...
const NoPermissions = () => {
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(dist.NoPermissions, null)));
};
...
function ComponentDragPreview({ displayedValue }) {
  return /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { maxWidth: (0,dist.pxToRem)(150) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral700", ellipsis: true }, displayedValue)))),
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/v2/SubNav/SubNavHeader.mjs
var SubNavHeader = __webpack_require__(32974);
...
const LeftMenu = () => {
  ...
  const { startsWith } = (0,dist.useFilter)(locale, {
    sensitivity: "base"
  });
  const formatter = (0,dist.useCollator)(locale, {
    sensitivity: "base"
...
const checkPermissions = (userPermissions, permissionsToCheck) => permissionsToCheck.map(({ permissions }) => (0,dist.hasPermissions)(userPermissions, permissions));
...
const App = () => {
  ...
  const { pathname } = (0,react_router/* useLocation */.TH)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { startSection } = (0,dist.useGuidedTour)();
  ...
  if (status === "loading") {
    ...
    ), /* @__PURE__ */ react.createElement(dist.LoadingIndicatorPage, null));
  }
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(App_LeftMenu, null) }, /* @__PURE__ */ react.createElement(DragLayer/* DragLayer */.r, { renderItem: renderDraglayerItem }), /* @__PURE__ */ react.createElement(contexts_ModelsContext.Provider, { value: { refetchData } }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/components/:uid/configurations/edit" }, /* @__PURE__ */ react.createElement(dist.CheckPagePermissions, { permissions: permissions.contentManager.componentsConfigurations }, /* @__PURE__ */ react.createElement(ComponentSetttingsView, null))), /* @__PURE__ */ react.createElement(
    react_router/* Route */.AW,
    {
...
const Body = () => {
  ...
  const { initialData, isCreatingEntry } = (0,dist.useCMEditViewDataManager)();
