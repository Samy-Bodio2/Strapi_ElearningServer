"use strict";
(self["webpackChunkstrapi_elearning"] = self["webpackChunkstrapi_elearning"] || []).push([[5199],{
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      withMainAction && /* @__PURE__ */ react.createElement(Cell.Td, { ...dist.stopPropagation }, /* @__PURE__ */ react.createElement(
      ...
      ), canDelete && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1, ...dist.stopPropagation }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
...
const FORM_SCHEMA = yup_es/* object */.Ry().shape({
  ...
  roles: yup_es/* array */.IX().min(1, dist.translatedErrors.required).required(dist.translatedErrors.required)
});
const STEPPER = {
  create: {
    buttonSubmitLabel: {
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(dist.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(dist.PaginationURLQuery, { pagination })));
};
...
const tableHeaders = [
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(dist.Status, { isActive, variant: isActive ? "success" : "danger" }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, formatMessage({
...
const UserListPageCE = () => {
  ...
  } = (0,dist.useRBAC)(permissions.settings.users);
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(dist.SettingsPageTitle, { name: "Users" }), /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, { canRead }, !canRead && /* @__PURE__ */ react.createElement(dist.NoPermissions, null), isError && /* @__PURE__ */ react.createElement("div", null, "TODO: An error occurred"), canRead && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    dist.DynamicTable,
    {
      contentType: "Users",
      isLoading,
...
const ProtectedListPage = () => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.CheckPagePermissions, { permissions: permissions.settings.users.main }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ListPage__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, null));
};
